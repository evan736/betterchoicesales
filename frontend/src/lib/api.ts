...
export const reshopAPI = {
  ...
  moveStage: (id: number, stage: string, extras?: { bound_carrier?: string; bound_premium?: number; lost_reason?: string; force_won?: boolean }) =>
    api.post(`/api/reshops/${id}/move`, null, { params: { stage, ...(extras || {}) } }),
  pulse: (params?: { no_touch_days?: number; assignee_id?: number }) =>

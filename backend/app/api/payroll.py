...
def submit_payroll(
    ...
    """Submit/finalize payroll for a month. Snapshots current monthly pay data."""
    ...
    record = PayrollRecord(
        ...
        total_agent_pay=pay_data.get("totals", {}).get("total_agent_pay", 0),
    ...
    for agent in pay_data.get("agent_summaries", []):
        line = PayrollAgentLine(
            ...
            total_agent_commission=agent.get("total_agent_commission", 0),
            ...
            net_agent_pay=agent.get("net_agent_commission", agent.get("total_agent_commission", 0)),

...
def generate_pastdue_pdf(
    ...
    c.setFillColor(medium_gray)
    disclaimer_lines = [
        "This is an automated notification generated by Better Choice Insurance Group and is intended for informational purposes only.",
        "The amount shown may not reflect recent payments or adjustments. Please contact your insurance carrier directly to verify",
        "your current balance and payment status before taking action. Better Choice Insurance Group is not responsible for any",
        "discrepancies between this notice and your carrier's records.",
    ]
    dy = 0.75 * inch
